...
export const Input = ({
    ...
    type = type === InputType.Email ? InputType.Text : type;
    ...
    return (
        <div className={classNames('input-container', size ? size : '', className)}>
            <div
            ...
            >
                ...
                />
                {preEndIcon ? (
                    <span className="input-icon end pre" onClick={onPreEndIconClick}>
                        {preEndIcon}
                    </span>
                ) : null}
                {endIcon ? (
